  ...
  return (
    <div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {services.map((service, index) => (
              <div key={index} className="p-6 rounded-xl border border-gray-700 hover:shadow-lg transition-shadow" style={{ backgroundColor: '#343a40' }}>
                {/* Icon */}
                <div className={`w-14 h-14 ${service.color} rounded-lg flex items-center justify-center mb-4 text-white`}>
                  {service.icon}
                </div>
      ...
      <section className="py-16 lg:py-24" style={{ backgroundColor: 'var(--color-surface)' }}>
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="mb-4">Technologies Maîtrisées</h2>
            <p className="text-lead text-ink-subtle max-w-2xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {techStack.map((stack, index) => (
              <div key={index} className="p-6 rounded-xl border border-gray-700" style={{ backgroundColor: '#343a40' }}>
                {/* Category Header */}
                <div className="flex items-center mb-4">
                  <div className="w-10 h-10 bg-gray-700 rounded-lg flex items-center justify-center mr-3 text-white">
                    {stack.icon}
                  </div>
                  <h3 className="font-semibold text-lg text-white">{stack.category}</h3>
                </div>
